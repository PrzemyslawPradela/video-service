...
<html>
    ...
    <body>
        ...
        <jsp:include page="GetVideosServlet"/>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body" style="text-align: center">
                            <a href="UpdateVideoServlet?id=${video.id}" class="card-link" style="float: left">
                                <i class="fa fa-edit fa-3x"></i>
                            </a>
                            <a href="DownloadVideoServlet?id=${video.id}" class="card-link">
                                <i class="fa fa-download fa-3x"></i>
                            </a>
                            <a href="RemoveVideoServlet?id=${video.id}" class="card-link" style="float: right">
