...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp"><i class="fa fa-home fa-lg"></i> Strona główna</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="add.jsp"><i class="fa fa-plus-square fa-lg"></i> Dodaj film <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container mt-5" style="width: 30%">
            <form action="AddVideoServlet" enctype="multipart/form-data" method="post">
